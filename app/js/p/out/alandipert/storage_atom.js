...
var x__18945__auto__ = (((this$ == null))?null:this$);
var m__18946__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__18945__auto__)]);
if(!((m__18946__auto__ == null))){
return m__18946__auto__.call(null,this$,not_found);
} else {
var m__18946__auto____$1 = (alandipert.storage_atom._get["_"]);
if(!((m__18946__auto____$1 == null))){
return m__18946__auto____$1.call(null,this$,not_found);
} else {
...
var x__18945__auto__ = (((this$ == null))?null:this$);
var m__18946__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__18945__auto__)]);
if(!((m__18946__auto__ == null))){
return m__18946__auto__.call(null,this$,value);
} else {
var m__18946__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if(!((m__18946__auto____$1 == null))){
return m__18946__auto____$1.call(null,this$,value);
} else {
...
var self__ = this;
var this$__$1 = this;
var temp__4423__auto__ = self__.store.getItem(tailrecursion.cljson.clj__GT_cljson.call(null,self__.key));
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__18888__auto__,writer__18889__auto__,opt__18890__auto__){
return cljs.core._write.call(null,writer__18889__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__20061 = atom;
cljs.core.add_watch.call(null,G__20061,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__20061,existing,debounce){
return (function (p1__20058_SHARP_,p2__20059_SHARP_,p3__20056_SHARP_,p4__20057_SHARP_){
if(cljs.core.truth_((function (){var and__18278__auto__ = alandipert.storage_atom._STAR_watch_active_STAR_;
if(cljs.core.truth_(and__18278__auto__)){
return cljs.core.not_EQ_.call(null,p3__20056_SHARP_,p4__20057_SHARP_);
} else {
return and__18278__auto__;
}
})())){
return debounce.call(null,((function (G__20061,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__20057_SHARP_);
});})(G__20061,existing,debounce))
,(function (){var or__18290__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR_20064 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_20064;
}} else {
var temp__4425__auto__ = tailrecursion.cljson.cljson__GT_clj.call(null,e.key);
if(cljs.core.truth_(temp__4425__auto__)){
var sk = temp__4425__auto__;
if(cljs.core._EQ_.call(null,sk,k)){
var _STAR_watch_active_STAR_20065 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,(function (){var temp__4423__auto__ = e.newValue;
if(cljs.core.truth_(temp__4423__auto__)){
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_20065;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__20066_SHARP_);
});})(default$))
);
});
/**
